...
def main():
    ...
    save_dir = args.save_dir or get_save_path(base_dir='result')
    ...
    train_loader = DataLoader(FoodSegDataset(dataset='train', **dataset_args), batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
